...
it('throws an exception when connector ID does not exist', function (): void {
    $request = new UpdateCommandRequest();
    $request->connector = new SimpleEntity(12, new TrimmedString('connecorId'), 'connectorId');
...
it('throws an exception when graph template ID does not exist', function (): void {
    $request = new UpdateCommandRequest();
    $request->graphTemplate = new SimpleEntity(12, new TrimmedString('graphTemplateId'), 'graphTemplateId');
